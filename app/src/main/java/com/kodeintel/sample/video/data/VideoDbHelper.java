...
package com.kodeintel.sample.video.data;

import android.content.Context;
import android.database.sqlite.SQLiteDatabase;
import android.database.sqlite.SQLiteOpenHelper;

import com.kodeintel.sample.video.data.VideoContract.VideoEntry;
...
public class VideoDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String SQL_CREATE_FAVOURITE_TABLE = "CREATE TABLE " + TABLE_FAVOURITE + " (" + VideoEntry._ID + "INTEGER PRIMARY KEY,"+ VideoEntry.COLUMN_NAME + " TEXT NOT NULL  );";
