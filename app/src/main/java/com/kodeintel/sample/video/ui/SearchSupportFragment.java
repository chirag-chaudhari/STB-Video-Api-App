...
public class SearchSupportFragment extends Fragment {
    ...
    private final Runnable mSetSearchResultProvider = new Runnable() {
        ...
        public void run() {
            ...
            if (preferences.contains("autoStart")) {
                boolean data = preferences.getBoolean("autoStart", false);
                mAutoStartRecognition = data;
            }
            if(mAutoStartRecognition == false){
                mSearchBar.focusChanger();
            }
