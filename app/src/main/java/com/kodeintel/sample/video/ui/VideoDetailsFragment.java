...
import com.kodeintel.sample.video.data.VideoDbHelper;
...
import com.kodeintel.sample.video.presenter.DetailsDescriptionPresenter;
...
public class VideoDetailsFragment extends DetailsSupportFragment
    ...
    private VideoDbHelper mVideoDBHelper;
    private SQLiteDatabase mDatabase;
    private String rent1 = "Add To";
    private String rent2 = "Favourite";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mSelectedVideo != null || !hasGlobalSearchIntent()) {
            ...
            setupAdapter();
            mVideoDBHelper = new VideoDbHelper(getContext());
            mDatabase = mVideoDBHelper.getReadableDatabase();
            Cursor c = mDatabase.rawQuery("SELECT suggest_text_1 FROM favourite WHERE suggest_text_1 = ?",new String[] {mSelectedVideo.title+""});
        ...
        detailsPresenter.setOnActionClickedListener(new OnActionClickedListener() {
            ...
            public void onActionClicked(Action action) {
                ...
                if(action.getId()== ACTION_RENT){
                    ...
                    mVideoDBHelper = new VideoDbHelper(getContext());
                    mDatabase = mVideoDBHelper.getWritableDatabase();

                    //Cursor c = mDatabase.rawQuery("SELECT suggest_text_1 FROM favourite WHERE suggest_text_1 = ?",new String[] {mSelectedVideo.title});
                    //Log.e("cursor","->"+c.getCount()+"");
                    if(isFavourite == true){
                        Log.e("rowId","in delete");
                        long rowId = mDatabase.delete("favourite","suggest_text_1 = ?",new String[]{mSelectedVideo.title});
                        Log.e("rowId","->"+rowId);
                        rent1 =  "Add to";
                        rent2 = "Favourite";
                        isFavourite = false;
                        ...
                        values.put("_idINTEGER",mSelectedVideo.id);
                        values.put("suggest_text_1",mSelectedVideo.title);
                        long rowId = mDatabase.insert("favourite",null,values);
                        Log.e("rowId","InCreate"+rowId);
                        rent1 = "";
                        rent2 = "Unfavourite";
                        isFavourite = true;
                        setupDetailsOverviewRow();
    ...
    private void setupDetailsOverviewRow() {
        ...
        Log.e("rent1",rent1);
        Log.e("rent2",rent2);
        adapter.set(ACTION_RENT, new Action(ACTION_RENT, rent1,
                rent2));
